...
echo "3. Deleting indels"
awk '$5 == "I" || $6 == "I" || $5 == "D" || $5 == "D"' ${prefix_plus1}_dataset_hapmap_autosomalSNPs.bim |cut -f2 >DI_snps
plink --noweb --bfile ${prefix_plus1}_dataset_hapmap_autosomalSNPs --exclude DI_snps --make-bed --out ${prefix_plus2}_dataset_hapmap_autosomalSNPs_DI_rm

# Add commands to delete ambiguous A/T G/C SNPs
