...
plink --noweb --bfile ${dataset} --exclude snps_to_rm.txt --make-bed --out ${prefix}_bad_snps_rm
...
plink --noweb --bfile ${prefix}_MAFlongregionRemoved --indep-pairwise 1500 100 0.2 --out ${prefix}_pruned
plink --noweb --bfile ${prefix}_MAFlongregionRemoved --extract ${prefix}_pruned.prune.in --make-bed --out ${prefix}_pruned
