...
unrelated2 <- read.table("unrelated.txt",header=TRUE)
all_pairs <- read.table("Step12_kinship.genome",header=TRUE)

fam <- read.table("Step11_pruned.fam",header=FALSE)
...
# write.csv(relationship_summary2(c("7004_304", "7004_301", "7027_302", "7027_305"), rbind(parent_offsprings,sib_pairs,second_degree_pairs,twins,unrelated2)),
#           "temp.csv", quote=F, row.names=F)
